...
contract FlowStrategyGovernor is Governor, GovernorVotes, GovernorCountingSimple, GovernorVotesQuorumFraction {
    ...
    ) Governor("FlowStrategyGovernor") GovernorVotes(_token) GovernorVotesQuorumFraction(_quorumPercentage) {
